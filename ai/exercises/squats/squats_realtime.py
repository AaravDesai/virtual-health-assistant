...
with open('trained_squats_model.pkl', 'rb') as file:
...
cap = cv2.VideoCapture('squats_videos/squatscorrect1.MOV')
...
out = cv2.VideoWriter('processed_squat_video.mp4', cv2.VideoWriter_fourcc(*'mp4v'), frame_rate, (frame_width, frame_height))
